...
//            });
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if(dif > 0.1) {
                    ...
                    sentiment += ("Negative with: " + df.format(neg*100) + "%").toString();
                }
                else if( dif < 0.12 ) {

                    sentiment += "Neutral".toString();
                }
                //textView.setText("Positive: "+sentimentPos+"\nNegative: "+sentimentNeg);
                System.out.print(ca.sentiment);
    ...
    private void findSentiment() {
        ...
        try {
            String encodeWord = URLEncoder.encode(addcomment.getText().toString(), "UTF-8");
    ...
    private void addComment(){
        ...
        hashMap.put("Sentiment", sentiment);
